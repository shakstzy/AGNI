---
name: macos
description: The macos adapter manages command execution, Xcode native builds, and tool discovery on Adithya's personal MacBook Pro over pinned Tailscale SSH.
---
