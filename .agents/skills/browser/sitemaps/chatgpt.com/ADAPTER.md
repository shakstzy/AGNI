...
## Purpose
OpenAI ChatGPT conversational web interface, GPT-4o / o1 reasoning, Canvas, and custom GPTs.

## Automation Standard
Automated through Browser Use CLI 3.0 via dedicated Chrome CDP port isolation:
```bash
./.agents/skills/browser/cli/browser opencli --site chatgpt.com --profile adithya --url https://chatgpt.com/
```
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/chatgpt.com/profiles/adithya/user_data`.
