...
# Pexels Browser Adapter

## Purpose
Pexels high-quality stock photography, free stock video library, and curated creative collections.

## Automation Standard
Automated through Browser Use CLI 3.0 via dedicated Chrome CDP port isolation:
```bash
./.agents/skills/browser/cli/browser opencli --site pexels.com --profile adithya --url https://www.pexels.com/
```
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/pexels.com/profiles/adithya/user_data`.
