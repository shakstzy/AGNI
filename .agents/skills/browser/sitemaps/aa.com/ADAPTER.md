...
# American Airlines Browser Adapter

## Purpose
American Airlines flight booking, reservation management, and AAdvantage loyalty status.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/aa.com/profiles/adithya/user_data`.
