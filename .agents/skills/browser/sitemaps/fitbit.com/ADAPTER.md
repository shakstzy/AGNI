...
# Fitbit Web Browser Adapter

## Purpose
Fitbit web dashboard for health metrics, daily steps, sleep tracking, and device battery status.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/fitbit.com/profiles/adithya/user_data`.
