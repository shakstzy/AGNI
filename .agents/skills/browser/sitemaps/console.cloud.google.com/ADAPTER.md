...
# Google Cloud Console Browser Adapter

## Purpose
Google Cloud Platform console for IAM, Compute Engine, Cloud Run, Storage, and Billing.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/console.cloud.google.com/profiles/adithya/user_data`.
