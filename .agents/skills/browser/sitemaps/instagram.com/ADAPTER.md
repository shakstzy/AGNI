...
## Purpose
Instagram visual network for creator profiles, reels, direct message inquiries, and media posts.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/instagram.com/profiles/adithya/user_data`.
