...
# Hugging Face Browser Adapter

## Purpose
Hugging Face AI community hub for models, datasets, Spaces applications, and inference endpoints.

## Automation Standard
Automated through Browser Use CLI 3.0 via dedicated Chrome CDP port isolation:
```bash
./.agents/skills/browser/cli/browser opencli --site huggingface.co --profile adithya --url https://huggingface.co/models
```
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/huggingface.co/profiles/adithya/user_data`.
