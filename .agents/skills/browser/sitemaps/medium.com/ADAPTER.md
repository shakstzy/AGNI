...
# Medium Browser Adapter

## Purpose
Medium publishing platform for reading technical articles, author stats, and publishing drafts.

## Automation Standard
Automated through Browser Use CLI 3.0 via dedicated Chrome CDP port isolation:
```bash
./.agents/skills/browser/cli/browser opencli --site medium.com --profile adithya --url https://medium.com/
```
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/medium.com/profiles/adithya/user_data`.
