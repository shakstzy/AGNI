...
# Google Ads Browser Adapter

## Purpose
Google Ads advertising console for search/display campaigns, keyword planner, and ad spend monitoring.

## Automation Standard
Automated through Browser Use CLI 3.0 via dedicated Chrome CDP port isolation:
```bash
./.agents/skills/browser/cli/browser opencli --site ads.google.com --profile adithya --url https://ads.google.com/aw/campaigns
```
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/ads.google.com/profiles/adithya/user_data`.
