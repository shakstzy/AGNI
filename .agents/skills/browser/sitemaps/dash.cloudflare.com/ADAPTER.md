...
# Cloudflare Dashboard Browser Adapter

## Purpose
Cloudflare dashboard for DNS zone management, Workers & Pages, edge rules, and Zero Trust security.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/dash.cloudflare.com/profiles/adithya/user_data`.
