...
# Shopify Admin Browser Adapter

## Purpose
Shopify merchant admin panel for store settings, products, apps, and order fulfillment.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/shopify.com/profiles/adithya/user_data`.
