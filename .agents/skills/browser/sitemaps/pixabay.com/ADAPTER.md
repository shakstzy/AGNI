...
# Pixabay Browser Adapter

## Purpose
Pixabay royalty-free stock imagery, vector graphics, illustration, and footage search.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/pixabay.com/profiles/adithya/user_data`.
