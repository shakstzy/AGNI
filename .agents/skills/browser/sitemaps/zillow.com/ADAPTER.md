...
# Zillow Rental Manager Browser Adapter

## Purpose
Zillow Rental Manager for landlord listings, tenant applications, leads, and lease messaging.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/zillow.com/profiles/adithya/user_data`.
