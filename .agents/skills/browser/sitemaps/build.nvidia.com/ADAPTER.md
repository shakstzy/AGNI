...
# NVIDIA NIM Browser Adapter

## Purpose
NVIDIA Inference Microservices (NIM) cloud catalog, foundation model APIs, and deployment containers.

## Automation Standard
Automated through Browser Use CLI 3.0 via dedicated Chrome CDP port isolation:
```bash
./.agents/skills/browser/cli/browser opencli --site build.nvidia.com --profile adithya --url https://build.nvidia.com/explore/discover
```
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/build.nvidia.com/profiles/adithya/user_data`.
