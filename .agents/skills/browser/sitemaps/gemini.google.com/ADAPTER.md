...
# Google Gemini Browser Adapter

## Purpose
Google Gemini consumer AI assistant, Deep Research, and multimodal conversation canvas.

## Automation Standard
Automated through Browser Use CLI 3.0 via dedicated Chrome CDP port isolation:
```bash
./.agents/skills/browser/cli/browser opencli --site gemini.google.com --profile adithya --url https://gemini.google.com/app
```
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/gemini.google.com/profiles/adithya/user_data`.
