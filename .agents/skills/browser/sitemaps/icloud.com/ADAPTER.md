...
# iCloud & iCloud Mail Browser Adapter

## Purpose
Apple iCloud web suite for iCloud Mail, Notes, Reminders, Calendar, and Find My.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/icloud.com/profiles/adithya/user_data`.
