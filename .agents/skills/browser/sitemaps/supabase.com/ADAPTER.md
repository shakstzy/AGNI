...
# Supabase Dashboard Browser Adapter

## Purpose
Supabase cloud console for project management, PostgreSQL database, authentication, and storage.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/supabase.com/profiles/adithya/user_data`.
