...
# AutoDS Browser Adapter

## Purpose
AutoDS dropshipping automation platform for product import, pricing rules, and auto-ordering.
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/autods.com/profiles/adithya/user_data`.
