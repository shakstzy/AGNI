...
# Awwwards Browser Adapter

## Purpose
Awwwards web design inspiration, Site of the Day archives, design systems, and developer awards.

## Automation Standard
Automated through Browser Use CLI 3.0 via dedicated Chrome CDP port isolation:
```bash
./.agents/skills/browser/cli/browser opencli --site awwwards.com --profile adithya --url https://www.awwwards.com/websites/
```
...
- **Profile Persistence**: Stateful Chrome session stored under `/home/shakstzy/HADES/.agents/skills/browser/sitemaps/awwwards.com/profiles/adithya/user_data`.
